...
public class UserApi {
    ...
    public ResponseEntity<ResponseDTO> registerUser(@RequestBody UserDTO userDTO) throws HmsException, com.hms.user.exception.HmsException {
...
final UserDetails userDetails = userDetailsService.loadUserByUsername(loginDTO.getEmail());
   ...
   return new ResponseEntity<>(jwt,HttpStatus.OK);
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String email) throws HmsException, com.hms.user.exception.HmsException {
