...
private String chronicDisease;
    ...
    public Patient(Long id, String name, String email, LocalDate dob, String phone,String address,String aadharNo, BloodGroup bloodGroup,String allergies,String chronicDisease) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.dob = dob;
