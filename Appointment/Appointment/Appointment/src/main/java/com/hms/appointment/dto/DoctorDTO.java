...
public class DoctorDTO {
    ...
    public DoctorDTO(String address, BloodGroup bloodGroup, String department, LocalDate dob, String email, Long id, String licenseNo, String name, String phone, String specialization, Integer totalExp) {
        this.address = address;
        this.bloodGroup = bloodGroup;
        this.department = department;
        this.dob = dob;
